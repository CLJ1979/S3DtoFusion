...
#     futil.log("geomdl found", adsk.core.LogLevels.InfoLogLevel, True)
# except:
#     futil.log("geomdl not found, installing it now...", adsk.core.LogLevels.InfoLogLevel, True)
#     eqs = subprocess.run([sys.executable, '-m', 'pip', 'install', 'geomdl'], check=True, capture_output=True, shell=False, timeout=40)
#     import geomdl
#     futil.log("Done", adsk.core.LogLevels.InfoLogLevel, True)